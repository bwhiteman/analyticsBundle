...
import com.potomacfusion.asfframework.ResourceDeployer;
 ...
 * @author SPines
 */
public class ResourceDeployerTest extends ResourceDeployer {
    ...
    public void testResourceBranchingLogic() {
        try {
            ...
            Map<String, Integer> temp = ResourceDeployerTest.deployResourcesTest(validPythonHadoop);
